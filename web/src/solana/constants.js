...
export const COLLECT_CREATOR_FEE_V2_DISC = new Uint8Array([207, 17, 138, 242, 4, 34, 19, 56]);
export const COLLECT_COIN_CREATOR_FEE_DISC = new Uint8Array([160, 57, 89, 42, 181, 139, 43, 66]);
